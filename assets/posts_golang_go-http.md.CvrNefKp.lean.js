import{_ as s,c as a,a0 as p,o as e}from"./chunks/framework.DADtiyJ8.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"posts/golang/go-http.md","filePath":"posts/golang/go-http.md"}'),t={name:"posts/golang/go-http.md"};function l(i,n,c,r,o,h){return e(),a("div",null,n[0]||(n[0]=[p(`<p>golang http 包源码简介(中间件实现原理/函数作为接口):</p><p>下面4段代码都可以开启一个http服务,他们有什么区别呢?</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>type myHandler struct {</span></span>
